...
import { ScrollTrigger } from "gsap/ScrollTrigger"; // Fixed import path
import useEmblaCarousel from "embla-carousel-react";
import Autoplay from "embla-carousel-autoplay";
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.from(headingRef.current, {
        opacity: 0,
        y: 40,
        duration: 0.8, // Slightly smoother duration
        ease: "power3.out",
        scrollTrigger: {
          trigger: headingRef.current,
          start: "top 85%",
    ...
    }, headingRef); // Scope to ref

    return () => ctx.revert(); // Kills animation when component unmounts
  }, []);

  // --- Carousel Logic (Unchanged but cleaned) ---
  const movies = [
    { id: 1, image: "/glimpses/glimpses1.jpg" },
    { id: 2, image: "/glimpses/glimpses2.jpg" },
    { id: 3, image: "/glimpses/glimpses3.jpg" },
